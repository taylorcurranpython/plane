...
function ServiceHealthSection() {
  return (
    <section className="space-y-3">
      <SectionHeading title="System health" description="Live status of the core services powering this instance." />
...
function UsageMetricsSection() {
  return (
    <section className="space-y-3">
      <SectionHeading title="Usage" description="Adoption across the instance over the last 30 days." />
