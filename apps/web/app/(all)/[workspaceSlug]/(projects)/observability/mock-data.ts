...
export const MOCK_USAGE_METRICS: TUsageMetric[] = [
  { label: "Active users (30d)", value: "64", change: 6.2, sparkline: [41, 45, 48, 50, 55, 60, 64] },
  { label: "Members", value: "86", change: 2.8, sparkline: [72, 74, 75, 79, 81, 84, 86] },
  { label: "Projects", value: "18", change: 4.1, sparkline: [12, 13, 14, 15, 16, 17, 18] },
  { label: "Work items", value: "4,213", change: 9.7, sparkline: [41, 44, 47, 49, 52, 55, 59] },
];
