...
// components
import { SignOutConfirmationModal } from "@/components/account/sign-out-confirmation-modal";
...
export const UserMenuRoot = observer(function UserMenuRoot() {
  ...
  return (
    <>
      <SignOutConfirmationModal isOpen={isSignOutModalOpen} onClose={() => setIsSignOutModalOpen(false)} />
      <CustomMenu
      ...
      >
        ...
        <CustomMenu.MenuItem onClick={() => setIsSignOutModalOpen(true)} className="flex items-center gap-2">
